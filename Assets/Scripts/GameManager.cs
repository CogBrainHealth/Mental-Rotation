    ...
    private void displayResult()
    {
        ...
        if (Score > 96.0f)
        {
            ...
            message.text += "그림 돌리기 게임을 통해 공간 지각 능력을 검사했어요!\n\n" +
                            " <sprite name=\"rocket\">최고 수준의 공간 지각 능력!\n" +
        ...
        else if (Score > 70.0f)
        {
            ...
            message.text += "그림 돌리기 게임을 통해 공간 지각 능력을 검사했어요!\n\n" +
                             " <sprite name=\"good\">균형 잡힌 공간 지각 능력!\n" +
        ...
        else if (Score > 60.0f)
        {
            ...
            message.text += "그림 돌리기 게임을 통해 공간 지각 능력을 검사했어요!\n\n" +
                             ...
                             " <sprite name=\"check\">더 나은 능력을 원한다면?\n" +
                             "- 주변 환경을 이용해보세요!\n" +
        ...
        else
        {
            ...
            message.text += "그림 돌리기 게임을 통해 공간 지각 능력을 검사했어요!\n\n" +
                             " <sprite name=\"weight\">조금 더 연습하면 공간 지각 능력이 향상될 거예요!\n" +
